...
function DHD{
    ...
    Log-Message "DHD complete" | Out-File -Append "C:\Users\ENG\Desktop\Admin Tools\UpdateLog.txt"
}
...
function ReplaceLaadSettings{
    ...
    Log-Message "ReplaceLaadSettings" | Out-File -Append "C:\Users\ENG\Desktop\Admin Tools\UpdateLog.txt"
}
...
function ReplaceBackupSettings{
    ...
    Log-Message "ReplaceBackupSettings" | Out-File -Append "C:\Users\ENG\Desktop\Admin Tools\UpdateLog.txt"
}
...
Log-Message "UpdateEncoder" | Out-File -Append "C:\Users\ENG\Desktop\Admin Tools\UpdateLog.txt"
}
    ...
    Set-Location $env:TEMP
        ...
        $ruw = Test-Path "C:\Users\ENG\Desktop\Admin Tools\Scripts\Presets\Custom\RUW.sqpreset"
            ...
            Copy-Item "C:\Users\ENG\Desktop\Admin Tools\Scripts\Presets\Custom\*" -Recurse -Destination 'C:\Users\ENG\Desktop\Allerlei nuttige dingen\Premiere Sequence Settings' -Force
                ...
                Log-Message "Presets" | Out-File -Append "C:\Users\ENG\Desktop\Admin Tools\UpdateLog.txt"
}
...
function PresetsMediaEncoder{
    Set-Location $env:TEMP
        ...
        $loudness = Test-Path "C:\Users\ENG\Desktop\Admin Tools\Scripts\Presets\Media Encoder Presets\Faspex met loudness.epr"
            ...
            Log-Message "PresetsMediaEncoder" | Out-File -Append "C:\Users\ENG\Desktop\Admin Tools\UpdateLog.txt"
}
...
function UpdateApps{
   ...
   Log-Message "UpdateApps" | Out-File -Append "C:\Users\ENG\Desktop\Admin Tools\UpdateLog.txt"
}
...
function Remove-DesktopItems{
    ...
    Remove-Item "C:\Users\Public\Desktop\Google*" -force
    Log-Message "Remove-DesktopItems" | Out-File -Append "C:\Users\ENG\Desktop\Admin Tools\UpdateLog.txt"
}
...
function ClearAdobeExport{
    ...
    Log-Message "ClearAdobeExport" | Out-File -Append "C:\Users\ENG\Desktop\Admin Tools\UpdateLog.txt"
}
